...
class Element {
	...
	constructor(tag, style, prefix, prepend, append) {
		this.tag = tag ?? 'LOG'
...
module.exports.Log = Element.create('LOG', this.Debug)
module.exports.Info = Element.create('INFO', this.Cyan)
module.exports.Debug = Element.create('DEBUG', this.Debug)
module.exports.Warn = Element.create('WARN', this.Yellow)
module.exports.Error = new Element('ERROR', this.Red, '|', Style.bold('Error'))
module.exports.Trace = Element.create('TRACE', this.Red)
module.exports.Success = Element.create('SUCCESS', this.Green)
module.exports.Important = new Element('IMPORTANT', Style.create(Style.bold('\x1b[35m'), '\x1b[45m'))
